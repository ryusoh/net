/**
 * X (Twitter): Custom Default Tab + UI Cleaner (Merged from x/content.js)
 * -------------------------------------------
 * Automatically hides the 'For you' tab and switches to the 'Following' feed.
 * Also hides premium prompts, Grok, and other UI clutter.
 * Default tab: Finance (as per original extension).
...
(function () {
  ...
  // Load user's preference from storage (defaults to 'finance')
